...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msaddpriceopt_core_path', null,
                    $modx->getOption('core_path') . 'components/msaddpriceopt/') . 'model/';
            $modx->addPackage('msaddpriceopt', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msaddpriceopt/model/schema/msaddpriceopt.mysql.schema.xml';
